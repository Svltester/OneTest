...
def test_am():
    ...
    def run(playwright: Playwright) -> None:
        browser = playwright.chromium.launch(headless=True, ignoreHTTPSErrors = True)
        context = browser.new_context()

        # Open new page
        page = context.new_page()

        page.goto("http://ia-test.egisz.rosminzdrav.ru/webadmin")
        ...
        page.wait_for_url("http://esia-portal1.test.gosuslugi.ru/login/")
        ...
        page.wait_for_url("http://www.gosuslugi.ru/")
